...
class StreamService {
  ...
  /// ✅ إصلاح حرج: إغلاق جميع StreamControllers لمنع Memory Leak
  void cleanup() {
    try {
      ...
      debugPrint('[StreamService] Cleanup completed');
    } catch (e) {
  ...
  Future<void> _closeAllPeerConnections() async {
    ...
    for (final pc in pcs) {
      try { 
        ...
        debugPrint('[StreamService] PC close error: $e');
      }
    }
  }
