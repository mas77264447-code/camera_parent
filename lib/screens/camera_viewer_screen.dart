  ...
  Future<void> _handleOffer(Map<String, dynamic> msg) async {
    ...
    if (_pc != null) {
      try { 
        ...
        debugPrint('[CameraViewer] PC close error: $e');
      }
      _pc = null;
    }
    _remoteStream = null;
    ...
    try {
      ...
      _pc?.onIceConnectionState = (state) {
        ...
        if (state == RTCIceConnectionState.RTCIceConnectionStateDisconnected) {
          debugPrint('[ICE] disconnected — attempting restart');
          _tryIceRestart();
        } else if (state == RTCIceConnectionState.RTCIceConnectionStateFailed) {
          debugPrint('[ICE] failed — full reconnect');
          _scheduleReconnect();
        }
      };
      ...
      // ✅ تحقق من أن answer ليست null قبل الاستخدام
      if (answer != null) {
